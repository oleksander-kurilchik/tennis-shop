...
<ul class="nav nav-pills ">
  <li class="nav-item">
    <a class="nav-link change_type files" href="#" data-type="files" >
      <i class="fa fa-folder fa-fw"></i> Файли
    </a>
  </li>
  <li class="nav-item">
    <a class="nav-link change_type images" href="#" data-type="images" >
      <i class="fa fa-folder fa-fw"></i> Зображення
    </a>
  </li>
...
<script>
  $(document).ready(function () {
    ...
    $ (".change_type."+$("#type").val()).addClass("active");
