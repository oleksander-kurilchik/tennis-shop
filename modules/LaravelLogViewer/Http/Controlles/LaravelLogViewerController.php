...
namespace TrekSt\Modules\LaravelLogViewer\Http\Controllers;
...
class LaravelLogViewerController extends AdminBaseController
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('permission:laravel_log_viewer.index')->only(['index','download']);
    }


    public function index()
    {
        $this->setCurrentBreadcrumbs('admin.laravel_log_viewer.index');
        ...
        return $this->view('admin.laravel_log_viewer.index', $data);
    }
