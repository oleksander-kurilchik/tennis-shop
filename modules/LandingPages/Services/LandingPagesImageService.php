...
namespace TrekSt\Modules\LaandingPages\Services;
...
class LandingPagesImageService
{
    protected static $diskName = 'news_images';
    protected static $imageNamePrefix = 'news_images';
    /** @var NewsImage $model */
    protected $model;
    ...
    protected static $bigSize = ['width' => 200, 'height' => 60];
    protected static $mediumSize = ['width' => 200, 'height' => 60];
    protected static $smallSize = ['width' => 100, 'height' => 30];
