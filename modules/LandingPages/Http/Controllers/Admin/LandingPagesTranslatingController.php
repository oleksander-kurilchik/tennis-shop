...
class LandingPagesTranslatingController extends Controller
{
    /**
    ...
    {
        $this->middleware('permission:pages.edit')->only(['update']);
    }

    public function update($id, Request $request)
    {
        $rules = array('title' => ['required',"min:3","max:255"],
            'description' => 'nullable|max:400000',
//            'short_description' => 'required|max:255',
        ...
        $translating =  LandingPageTranslating::findOrFail($id);
