...
class FiltersTranslating extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'filters_translating';
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['filters_id', 'languages_id', 'name', 'title', 'description','short_description',
        "seo_title",
        "seo_description",
        "seo_keywords",
        "seo_text",];
  public function language()
  {
    ...
    {
        $this->title  = $this->description = $this->short_description  =  null;
