...
class FiltersValuesTranslatingController extends Controller
{
    ...
    public function update($filters_id,$id, Request $request)
    {
        ...
        $translating =  FiltersValuesTranslating::findOrFail($id);
