                    ...
                    <form action=" " method="post">
                        ...
                        <div class="p-auth-reg__form-row">
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <div class="form-checkbox-primary">
                                        <input class="form-checkbox-primary__input-default" type="checkbox" value=""
                                        ...
                                        <a href="#" class="p-auth-reg__link-rules">правилами сайту</a>
                            ...
                            <div class="p-auth-reg__form-col-login w-100">
                                <a href="#" class="button-default-primary w-100 p-auth-reg__login-link">
                                    Ввійти
                                </a>
