<div class="b-product-item">
    <div   class="b-product-item__logo">
        ...
        <picture class="b-product-item__logo-picture">
            ...
            <source  type="image/webp"  srcset="{{$product->logo->path->path_1x_webp}}"   alt="" class="b-product-item__logo-img img-fluid">
{{--            <source  type="image/png"  srcset="/images/product_item/logo.png"   alt="" class="b-product-item__logo-img img-fluid">--}}
        ...
        <span class="b-product-item__label-favorite-block b-product-item__label-favorite-block_active">
          <span  class="b-product-item__label-favorite-active  js-remove-product-from-wishlist " data-id="{{$product->id}}">
