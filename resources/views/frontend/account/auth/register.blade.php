...
@section('content')
    ...
    <div class="p-auth p-auth-reg ">
        @include('frontend.global.parts.breadcrumbs')
        <div class="container">
            <div class="p-auth__form">
                <div class="p-auth-reg__form-block">
                    <div class="p-auth-reg__form-title">
                         @lang('account.register.title')
                    </div>
                    <form action="{{route('frontend.account.register')}}" method="post">
                        @csrf
                        <div class="p-auth-reg__form-row">
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <label for="" class="form-control__label">
                                        @lang('account.register.form.last_name.title')
                                    </label>
                                    <input type="text" class="form-control__default"
                                           name="last_name" value="{{ old('last_name') }}"
                                           placeholder="@lang('account.register.form.last_name.placeholder')">
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <label for="" class="form-control__label">
                                        @lang('account.register.form.first_name.title')
                                    </label>
                                    <input type="text" class="form-control__default"
                                           name="first_name" value="{{ old('first_name') }}"
                                           placeholder=" @lang('account.register.form.first_name.placeholder')"
                                    >
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <label for=""
                                           class="form-control__label"> @lang('account.register.form.phone.title')</label>
                                    <input type="phone" class="form-control__default" name="phone"
                                           placeholder="@lang('account.register.form.phone.placeholder')"
                                           value="{{ old('phone') }}"
                                    >
                                    @if ($errors->has('phone'))
                                        <span class="invalid-feedback d-block">
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <label for=""
                                           class="form-control__label">@lang('account.register.form.email.title')</label>
                                    <input type="email" class="form-control__default" name="email"
                                           placeholder="@lang('account.register.form.email.placeholder')"
                                           value="{{ old('email') }}"
                                    >
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback d-block">
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <label for=""
                                           class="form-control__label">@lang('account.register.form.password.title')</label>
                                    <input type="password" class="form-control__default" name="password"
                                           placeholder="@lang('account.register.form.password.placeholder')" value="">
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <label for=""
                                           class="form-control__label">@lang('account.register.form.password_confirmation.title') </label>
                                    <input type="password" class="form-control__default" name="password_confirmation"
                                           placeholder="@lang('account.register.form.password_confirmation.placeholder')"
                                           value=""
                                    >
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group form-group__default">
                                    <div class="form-checkbox-primary">
                                        <input name="rules-confirmation" class="form-checkbox-primary__input-default" type="checkbox" value="1"
                                               id="reg-rules-confirmation">
                                        <label class="form-checkbox-primary__label-default p-auth-reg__label-rules"
                                               for="reg-rules-confirmation">

                                            @lang('account.register.form.rules.title')
                                        </label>
                                        <a href="#" class="p-auth-reg__link-rules">
                                            @lang('account.register.form.rules.link')
                                        </a>
                                    ...
                                    @if ($errors->has('rules-confirmation'))
                                        <span class="invalid-feedback d-block">
                                        <strong>{{ $errors->first('rules-confirmation') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="p-auth-reg__form-col">
                                <div class="form-group  p-auth-reg__form-block-submit">
                                    <button type="submit"
                                            class="button-default p-auth-reg__form-block-submit-btn">@lang('account.register.form.register')
                                    </button>
                                </div>
                            </div>

                            <div class="p-auth-reg__form-col">
                                <div class="p-auth-reg__social-block">
                                    <div class="p-auth-reg__social-title">
                                        @lang('account.register.login_with_social')
                                    </div>

                                    <div class="p-auth-reg__social-links">
                                        <a href="#" class="p-auth-reg__social-facebook">
                                        ...
                                        <a href="#" class="p-auth-reg__social-google">
                            ...
                            <div class="p-auth-reg__form-col-login w-100">
                                <a href="{{route('frontend.account.login')}}" class="button-default-primary w-100 p-auth-reg__login-link">
                                    @lang('account.register.login')
                                </a>
