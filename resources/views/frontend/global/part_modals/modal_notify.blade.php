<div class="modal fade b-site-modal-dialog b-cart-modal-dialog " id="modalNotyfy" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg  modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="b-site-modal__logo pb-5">
                ...
                <div class="b-site-modal__description">
                ...
                <div class="row pt-5  d-none ">
                    ...
                    <div class="col-md-6">
                        <button class="button-default-primary w-100">
                            продовжити покупки
                        </button>
                    </div>
                </div>
