...
@section('content')
    <div class="card">
        <div class="card-header">Елементи меню </div>
        <div class="card-body">

            <div class="header-admin-button">

                <a href="{{ route('admin.menus.edit',['id'=>$menu->id]) }}" title="Назад ">
                    <button class="btn btn-success btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i>
                        Назад
                    </button>
                </a>
                <a href="{{ route('admin.menu_item.create',['menu_id'=>$menu->id]) }}" class="btn btn-success btn-sm"
                   title="">
                    <i class="fa fa-plus" aria-hidden="true"></i> Додати новий елемент меню
                </a>
            ...
            <div class=" ">
                <div class="dd">
                    @include('admin.menus.menu_item.parts.items_list',['items'=>$menuItems])
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.js-menu-items-order-save').click(function () {
                ...
                axios.post(@json(route('admin.menu_item.order',['menu_id'=>$menu->id])), formData)
