<div id="translate_item_{{$translating->id}}" class=" translating_item_wrapper form-admin">
    {!! Form::model($translating, [
                               'method' => 'PATCH',
                               'url' => route("admin.filters_values.update_translating",["filters_id"=>$filter->id,"id"=> $translating->id]),
        ...
        {{--<div class="card-body">--}}
            {{--<div class="panel-body-wrap">--}}
                    ...
                    {{--<div class="form-group {{ $bag->has('seo_text') ? 'has-error' : ''}}">--}}
                        {{--{!! Form::label('seo_text', 'Seo текст', ['class' => 'control-label']) !!}--}}
                        {{--<div class="">--}}
    ...
    <div class="form-group">
        <div class=" w-100 pt-4 text-center">
            {!! Form::submit( 'Зберігти', ['class' => 'btn btn-primary']) !!}
        </div>
    </div>
    {!! Form::close() !!}
</div>
