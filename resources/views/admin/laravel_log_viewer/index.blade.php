...
@section("sub_title") -  Логи @endsection
                        ...
                        <div class="list-group">
                            @foreach($files as $file)
                                <a href="?l={{ \Illuminate\Support\Facades\Crypt::encrypt($file) }}"
                                   class="list-group-item @if ($current_file == $file) llv-active bg-primary text-white @endif">
                                    {{$file}}
                                </a>
                            @endforeach
                        </div>
                        ...
                        <div class="p-3">
                            @if($current_file)
                                <a href="?dl={{ \Illuminate\Support\Facades\Crypt::encrypt($current_file) }}">
                                    <span class="fa fa-download"></span> Завантажити лог
                                </a>
