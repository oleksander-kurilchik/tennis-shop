...
@section('content')
    <div class="card">
        <div class="card-header">Ролі</div>
        <div class="card-body">

            <div class="header-admin-button">
                <a href="{{ route('admin.roles.create') }}" class="btn btn-success btn-sm"
                   title="">
                    <i class="fa fa-plus" aria-hidden="true"></i> Додати нову роль
                </a>
...
{{--                            <td>{{ $item->published?"Tak":"Ні"}}</td>--}}
                            <td>
                                ...
                                <a href="{{  route("admin.roles.show",["id"=>$item->id])}}" title="Перегляд">
                                ...
                                <a href="{{route("admin.roles.edit",["id"=>$item->id]) }}"
                                 ...
                                 {!! Form::open([
                                    'method'=>'DELETE',
                                    'url' => route("admin.roles.delete",["id"=>$item->id]),
