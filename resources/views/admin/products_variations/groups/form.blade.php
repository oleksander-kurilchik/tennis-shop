<div class="form-products-wrapper">
    ...
    <div class="form-group {{ $errors->has('type') ? 'has-error' : ''}}">
        {!! Form::label('type', 'Тип групи', ['class' => ' control-label']) !!}
        {!! Form::select('type', ['select' => 'Випадаючий список', 'tags' => 'Теги', 'colors' => 'Кольори'], null, ['class' => 'form-control']) !!}
        {!! $errors->first('type', '<p class="invalid-feedback d-block">:message</p>') !!}
    </div>
