            ...
            <div class="b-card-list__group-content">
                <validation-provider name="delivery_method" v-slot="{ errors }">
                    ...
                    <div class="form-check form-radio__default p-cart__form-radio">
                        <input class="form-check-input  form-radio-input__default" type="radio" name="delivery"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control__default js-select-delivery" @change="changeCity($event)">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control__default js-select-delivery " @change="changeWarehouse($event)">
                ...
                <template v-if="showCourierForm">
                    <div class="form-group">
                        ...
                        <label class="form-control__label"> {{ trans.city }} </label>
                        <input class="form-control__default" @change="updateCourierCity($event.target.value)">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control__default " @change="updateCourierWarehouse($event.target.value)"></textarea>
