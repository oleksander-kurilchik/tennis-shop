...
return [
    ...
    */
    ...
    'e164'=> 'Поле :attribute має бути номером телефону',
    ...
    */
    ...
    'custom' => [
        ...
        'image' => [
            'dimensions' => 'Поле :attribute містіть неприпустимі розміри зображення.  мінімальна ширина: :min_width,  мінімальна висота: :min_height, максимальна висота: :max_height, максимальна ширина: :max_width',
        ...
        'city_name' => [
            'required_if'          => "Поле :attribute є обов'язковим для заповнення.",
        ], 'warehouse_name' => [
            'required_if'          => "Поле :attribute є обов'язковим для заповнення.",
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'available'             => 'Доступно',
        'size'                  => 'Розмір',
        'payment_method'        => 'cпосіб оплати',
        'delivery_method'         => 'cпосіб доставки',
        'city_name'             => 'місто',
        'warehouse_name'        => 'віділення',
        'rules-confirmation'=>'правила сайту',
    ],
];
