...
.url:hover
{
  ...
  <body>
	<div id="content">
	  	<h2>XML Sitemap</h2>
		<p class="expl"> <img src="/images/header/logo.png" ></img> </p>
		<p class="expl"> Створено <a href="https://trek-st.com/" target="_blank"  >"Веб-студія «ТРЕК»"</a></p>
		<p class="expl"> Сайт мап має <xsl:value-of select="count(s:urlset/s:url)"/> URLs.</p>
